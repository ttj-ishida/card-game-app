...
export const jaDictionary = {
  ...
  'onlineRoom.error.inviteInvalid': '招待コードは英数字4〜16文字で入力してください。',
  'onlineRoom.error.inviteTaken': 'その招待コードは使われています。別のコードにしてください。',
  ...
  'onlineRoom.invite.shareLead':
    'ラグナロク・ミレニアムのフレンド対戦への招待です。下のリンクを開いてください。',
  'onlineRoom.join.title': 'フレンド対戦への招待',
  'onlineRoom.join.codeLabel': '招待コード',
  'onlineRoom.join.openApp': 'アプリで開く',
  'onlineRoom.join.getAppAndroid': 'Google Play で入手',
  'onlineRoom.join.getAppIos': 'App Store で入手',
  'onlineRoom.join.iosComingSoon': 'iOS版は準備中です。',
  'onlineRoom.join.playOnWeb': 'このままブラウザで参加',
  'onlineRoom.join.hint': 'アプリを入れると、次回からリンクで直接開けます。',
  ...
  'cpuGame.field.trail.lead': 'リード',
  'cpuGame.field.trail.latest': '最終出し手',
  'cpuGame.field.trail.nthSuffix': '番目',
  ...
  'cpuGame.exit.button': '退出',
  'nav.menuTitle': 'メニュー',
  'nav.close': '閉じる',
  'nav.home': 'ホーム',
  'nav.cpuGame': 'CPU戦',
  'nav.onlineRoom': 'フレンド対戦',
  'nav.catalog': 'カードカタログ',
  'nav.sandbox': 'ルールサンドボックス',
  'nav.settings': '設定',
